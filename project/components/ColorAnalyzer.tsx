...
export const ColorAnalyzer: React.FC<ColorAnalyzerProps> = ({ color, visible, onClose }) => {
  const { colors, isColorCorrectionEnabled } = useTheme();
      ...
      <View style={[styles.modalContainer, { backgroundColor: 'rgba(0, 0, 0, 0.5)' }]}>
        <View style={[styles.modalContent, { backgroundColor: colors.card }]}>
          <View style={styles.header}>
            <Text style={[styles.title, { color: colors.text }]}>Color Analysis</Text>
          ...
          <ScrollView style={styles.scrollContent}>
            <View style={styles.colorPreviewContainer}>
              ...
              <Text style={[styles.colorName, { color: colors.text }]}>{colorName}</Text>
              <Text style={[styles.colorHex, { color: colors.secondary }]}>{color}</Text>
              {needsCorrection && isColorCorrectionEnabled && (
                <View style={styles.correctionBadge}>
                  <Text style={styles.correctionText}>Color Correction Active</Text>
                </View>
              )}
            </View>
            
            <View style={[styles.colorDataContainer, { backgroundColor: colors.background }]}>
              <View style={styles.dataRow}>
                <View style={styles.dataItem}>
                  <Text style={[styles.dataLabel, { color: colors.secondary }]}>RGB</Text>
                  <Text style={[styles.dataValue, { color: colors.text }]}>
                    {`${rgb.r}, ${rgb.g}, ${rgb.b}`}
                  </Text>
                </View>
                <View style={styles.dataItem}>
                  <Text style={[styles.dataLabel, { color: colors.secondary }]}>LAB</Text>
                  <Text style={[styles.dataValue, { color: colors.text }]}>
          ...
          <View style={[styles.actionBar, { borderTopColor: colors.border }]}>
            ...
            >
              ...
              <Text style={[styles.actionText, { color: colors.primary }]}>Add to Palette</Text>
            </TouchableOpacity>
